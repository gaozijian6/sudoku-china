                ...
                if uniqueCols.count == 4 {
                  ...
                  if !deletedPositions.isEmpty {
                    ...
                    return [
                      ...
                      "prompt": promptDicts,
                      "method": SolutionMethods.JELLYFISH_ROW,
                      "target": [num],
                    ]
                  }
                }
                ...
                if uniqueRows.count == 4 {
                  ...
                  for row in uniqueRows {
                    if let positions = candidateMap[num]?.row[row]?.positions {
                      for pos in positions {
                        if ![col1, col2, col3, col4].contains(pos.col) {
                          deletedPositions.append(pos)
                        }
                      }
                    }
                  ...
                  if !deletedPositions.isEmpty {
                    ...
                    return [
                      ...
                      "position": positionDicts,
                      "prompt": promptDicts,
                      "method": SolutionMethods.JELLYFISH_COLUMN,
                      "target": [num],
                    ]
                  }
                }
