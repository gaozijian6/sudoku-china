export default {
  translation: {
    ...
    boardLimit:
      'Sudoku bulmaca sayısı üst sınıra ulaştı, yalnızca 300 bulmacaya kadar oluşturabilirsiniz',
    updateAvailable: 'Güncelleme mevcut',
    updateMessage:
      'Yeni sürüm {{version}} mevcut. Daha iyi deneyim ve en yeni özellikler için güncelleme yapmanızı öneririz.',
    ...
    storageSpaceInsufficientDescription:
      'iCloud depolama alanı dolu. Lütfen depolama alanını temizleyin ve tekrar deneyin, veya iCloud depolama planınızı yükseltin.',
    networkConnectionFailed: 'Ağ bağlantısı başarısız',
    networkConnectionFailedDescription:
      'Lütfen ağ bağlantınızı ve iCloud ayarlarınızı kontrol edin ve tekrar deneyin.',
    ...
    customSound: 'Özel',
    errorSound: 'Hata Ses Efekti',
    successSound: 'Başarılı Doldurma Ses Efekti 1',
    switchSound: 'Geçiş Ses Efekti',
    eraseSound: 'Silme Ses Efekti',
    successSound2: 'Başarılı Doldurma Ses Efekti 2',
    gameCompleteSound: 'Oyun Tamamlanma Ses Efekti',
    currentSound: 'Mevcut Ses Efekti',
    change: 'Değiştir',
    customSoundDescription:
      'Ses efektini dinlemek için oynat düğmesine, farklı ses dosyalarını değiştirmek için değiştir düğmesine tıklayın.',
    soundSettingsSaved: 'Ses ayarları kaydedildi',
    resetToDefault: 'Varsayılana Sıfırla',
    resetSoundSettingsConfirm: 'Varsayılan ses ayarlarına sıfırlamak istediğinizden emin misiniz?',
    selectSound: 'Ses Seç',
    default: 'Varsayılan',
    save: 'Kaydet',
    // 音效名称翻译
