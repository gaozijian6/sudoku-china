export default {
  translation: {
    ...
    storageSpaceInsufficientDescription:
      'iCloud儲存空間已滿，請清理儲存空間後重試，或者升級您的iCloud儲存計劃。',
    ...
    customSound: '自定義',
    errorSound: '錯誤音效',
    successSound: '填入成功音效1',
    switchSound: '切換音效',
    eraseSound: '擦除音效',
    successSound2: '填入成功音效2',
    gameCompleteSound: '遊戲完成音效',
    currentSound: '目前音效',
    change: '更換',
    customSoundDescription: '點選播放按鈕試聽音效，點選更換按鈕切換不同的音效檔案。',
    soundSettingsSaved: '音效設定已儲存',
    resetToDefault: '恢復預設',
    resetSoundSettingsConfirm: '確定要恢復預設音效設定嗎？',
    selectSound: '選擇音效',
    default: '預設',
    save: '儲存',
    // 音效名称翻译
