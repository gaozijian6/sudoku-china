export default {
  translation: {
    ...
    successSound: 'Son de Succès 1', 
    switchSound: 'Son de Changement',
    eraseSound: 'Son d\'Effacement',
    successSound2: 'Son de Succès 2',
    gameCompleteSound: 'Son de Fin de Jeu',
    currentSound: 'Son Actuel',
    change: 'Changer',
    customSoundDescription: 'Cliquez sur le bouton de lecture pour prévisualiser les sons, cliquez sur le bouton changer pour basculer entre différents fichiers sonores.',
    soundSettingsSaved: 'Paramètres audio sauvegardés',
    resetToDefault: 'Remettre par Défaut',
    resetSoundSettingsConfirm: 'Êtes-vous sûr de vouloir remettre les paramètres audio par défaut?',
