export default {
  translation: {
    ...
    boardLimit: '数独パズルの数が上限に達しました。最大300個のパズルまで作成できます',
    updateAvailable: 'アップデート利用可能',
    updateMessage: '新しいバージョン{{version}}が利用可能です。より良い体験と最新機能のためにアップデートをお勧めします。',
    updateNow: '今すぐアップデート',
    later: '後で',
    contactAuthor: '作者に連絡',
    storageSpaceInsufficient: 'ストレージ容量不足',
    storageSpaceInsufficientDescription: 'iCloudストレージ容量が満杯です。ストレージ容量を整理してから再試行するか、iCloudストレージプランをアップグレードしてください。',
    networkConnectionFailed: 'ネットワーク接続失敗',
    ...
    eraseSound: '消去音',
    successSound2: '成功音2',
    gameCompleteSound: 'ゲーム完了音',
    currentSound: '現在の音',
    change: '変更',
    customSoundDescription: '再生ボタンをクリックして音をプレビューし、変更ボタンをクリックして異なる音声ファイルを切り替えます。',
    soundSettingsSaved: 'サウンド設定が保存されました',
    resetToDefault: 'デフォルトに戻す',
    resetSoundSettingsConfirm: 'デフォルトのサウンド設定に戻してもよろしいですか？',
    selectSound: '音を選択',
    default: 'デフォルト',
    save: '保存',
    // 音効名称翻译
