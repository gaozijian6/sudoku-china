export default {
  translation: {
    ...
    boardLimit: 'Il numero di puzzle sudoku ha raggiunto il limite massimo, puoi creare solo fino a 300 puzzle',
    ...
    storageSpaceInsufficient: 'Spazio di archiviazione insufficiente',
    storageSpaceInsufficientDescription: 'Lo spazio di archiviazione iCloud è pieno. Si prega di liberare spazio di archiviazione e riprovare, o aggiornare il piano di archiviazione iCloud.',
    networkConnectionFailed: 'Connessione di rete fallita',
    networkConnectionFailedDescription: 'Si prega di controllare la connessione di rete e le impostazioni iCloud e riprovare.',
    saveFailed: 'Salvataggio fallito',
    saveFailedDescription: 'Si è verificato un errore durante il salvataggio dei dati su iCloud: {{error}}',
