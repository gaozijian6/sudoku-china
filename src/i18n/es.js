  ...
  translation: {
    ...
    hints: {
      ...
      DOUBLE_COLOR_CHAIN_delete:
        'cuando {{posStr}} toma {{target1}}, la celda roja no puede tomar {{target2}}',
    ...
    successSound: 'Sonido de Éxito 1', 
    switchSound: 'Sonido de Cambio',
    eraseSound: 'Sonido de Borrar',
    successSound2: 'Sonido de Éxito 2',
    gameCompleteSound: 'Sonido de Juego Completado',
    currentSound: 'Sonido Actual',
    change: 'Cambiar',
    customSoundDescription: 'Haga clic en el botón de reproducción para previsualizar sonidos, haga clic en el botón cambiar para alternar entre diferentes archivos de sonido.',
    soundSettingsSaved: 'Configuración de sonido guardada',
    resetToDefault: 'Restablecer a Predeterminado',
    resetSoundSettingsConfirm: '¿Está seguro de que desea restablecer la configuración de sonido predeterminada?',
