export default {
  translation: {
    ...
    boardLimit:
      'Số lượng câu đố sudoku đã đạt đến giới hạn trên, bạn chỉ có thể tạo tối đa 300 câu đố',
    updateAvailable: 'Có bản cập nhật',
    updateMessage:
      'Phiên bản mới {{version}} đã có sẵn. Chúng tôi khuyên bạn nên cập nhật để có trải nghiệm tốt hơn và các tính năng mới nhất.',
    updateNow: 'Cập nhật ngay',
    later: 'Để sau',
    contactAuthor: 'Liên hệ tác giả',
    storageSpaceInsufficient: 'Không đủ dung lượng lưu trữ',
    storageSpaceInsufficientDescription:
      'Dung lượng lưu trữ iCloud đã đầy. Vui lòng dọn dẹp dung lượng lưu trữ và thử lại, hoặc nâng cấp gói lưu trữ iCloud của bạn.',
    networkConnectionFailed: 'Kết nối mạng thất bại',
    networkConnectionFailedDescription:
      'Vui lòng kiểm tra kết nối mạng và cài đặt iCloud của bạn và thử lại.',
    ...
    customSound: 'Tùy chỉnh',
    errorSound: 'Âm thanh lỗi',
    successSound: 'Âm thanh điền thành công 1',
    switchSound: 'Âm thanh chuyển đổi',
    eraseSound: 'Âm thanh xóa',
    successSound2: 'Âm thanh điền thành công 2',
    gameCompleteSound: 'Âm thanh hoàn thành trò chơi',
    currentSound: 'Âm thanh hiện tại',
    change: 'Thay đổi',
    customSoundDescription:
      'Nhấp vào nút phát để nghe âm thanh, nhấp vào nút thay đổi để chuyển đổi các tệp âm thanh khác nhau.',
    soundSettingsSaved: 'Cài đặt âm thanh đã được lưu',
    resetToDefault: 'Khôi phục mặc định',
    resetSoundSettingsConfirm: 'Bạn có chắc chắn muốn khôi phục cài đặt âm thanh mặc định không?',
