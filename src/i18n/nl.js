export default {
  translation: {
    ...
    boardLimit: 'Het aantal sudokus heeft de bovengrens bereikt, u kunt slechts tot 300 puzzels maken',
    ...
    later: 'Later',
    contactAuthor: 'Contact de auteur',
    storageSpaceInsufficient: 'Onvoldoende opslagruimte',
    storageSpaceInsufficientDescription: 'iCloud opslagruimte is vol. Maak opslagruimte vrij en probeer opnieuw, of upgrade uw iCloud opslagplan.',
    networkConnectionFailed: 'Netwerkverbinding mislukt',
